...
static const _SentryStatus_type_support_symbol_names_t _SentryStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sentry_interface, msg, SentryStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sentry_interface, msg, SentryStatus)),
  }
};
...
{
  return &::sentry_interface::msg::rosidl_typesupport_cpp::SentryStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sentry_interface, msg, SentryStatus)() {
  return get_message_type_support_handle<sentry_interface::msg::SentryStatus>();
}
