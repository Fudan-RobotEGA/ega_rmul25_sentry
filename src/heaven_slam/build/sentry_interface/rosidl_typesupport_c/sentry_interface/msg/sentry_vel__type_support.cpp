...
static const _SentryVel_type_support_symbol_names_t _SentryVel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sentry_interface, msg, SentryVel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sentry_interface, msg, SentryVel)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sentry_interface, msg, SentryVel)() {
  return &::sentry_interface::msg::rosidl_typesupport_c::SentryVel_message_type_support_handle;
}
